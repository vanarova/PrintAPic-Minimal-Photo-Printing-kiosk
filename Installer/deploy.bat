...
xcopy "..\PicsDirectoryDisplayWin\bin\Release" "Setup\PicsDirectoryDisplayWin\bin\Release" /c /d /e /h /i /k /q /r /s /x /y

xcopy "..\PicsDirectoryDisplayWin\bin\AllReceipts" "Setup\PicsDirectoryDisplayWin\bin\AllReceipts" /c /d /e /h /i /k /q /r /s /x /y

xcopy "..\PrintAPicStart\bin\Release" "Setup\PrintAPicStart\bin\Release" /c /d /e /h /i /k /q /r /s /x /y
...
xcopy "Setup\PicsDirectoryDisplayWin\bin\Release\PicsDirectoryDisplayWin.exe" "Setup\PrintAPicStart\bin\Release" /c /d /e /h /i /k /q /r /s /x /y

xcopy "Setup\PicsDirectoryDisplayWin\bin\Release\PicsDirectoryDisplayWin.exe.config" "Setup\PrintAPicStart\bin\Release" /c /d /e /h /i /k /q /r /s /x /y
